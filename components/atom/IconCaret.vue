<template>
  <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
       style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2" width="16" height="9"
       viewBox="0 0 32 18"
       :class="['u-icon-caret', `u-icon-caret--${direction}`]">
  <path
    ...
    style="fill-rule:nonzero" transform="translate(0 .273) scale(1.71428)"/>
  </svg>
</template>
